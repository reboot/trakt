...
/**
 * An exception thrown when a request fails for an unexpected reason.
 */
public class RequestFailedException extends TraktClientException {
    ...
    /**
     * Constructs a request failed exception with a message.
     *
    ...
    /**
     * Constructs a request failed exception with a message and an exception
